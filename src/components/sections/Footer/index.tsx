    ...
    return (
        <footer
            className={classNames(
                ...
                styles?.self?.padding ? mapStyles({ padding: styles?.self?.padding }) : 'px-4 pt-16 pb-8'
            )}
        ...
        >
            <div className="mx-auto max-w-7xl">
                <div className="grid sm:grid-cols-3 lg:grid-cols-4 gap-8">
                    ...
                    {tertiaryLinks && <FooterLinksGroup {...tertiaryLinks} {...(enableAnnotations && { 'data-sb-field-path': '.tertiaryLinks' })} />}
                    {/* add new tertiaryLinks */}
                </div>
                {(copyrightText || socialLinks.length > 0 || legalLinks.length > 0) && (
                    <div className="sb-footer-bottom border-t pt-8 flex flex-col sm:flex-row sm:flex-wrap sm:justify-between">
                        {/* Moved socialLinks here */}
